...
prompt_list = ['super cat saves the world from the evil racoons', 'super cat saves a kitten', 'super cat travels to the amazon', 'super cat tames a dragon', 'super cat fights a giant robot', 'super cat saves the city from a meteor', 'super cat saves the city from a tornado', 'super cat saves the city from a flood', 'super cat saves the city from an earthquake', 'super cat saves the city from a volcano']
...
for i, prompt in enumerate(prompt_list):
    ...
    story_messages = [
        ...
        {"role": "user", "content": f"Write an story about : {prompt}. Only output the story, nothing else."},
    ]
