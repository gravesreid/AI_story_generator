...
id_length = 4
num_steps = 50
general_prompt = "a superhero pink dog with rainbow eyes with a yellow cape"
negative_prompt = "naked, deformed, bad anatomy, city style, disfigured, poorly drawn face, mutation, extra limb, ugly, disgusting, poorly drawn hands, missing limb, extra limb, extra tail, floating limbs, disconnected limbs, blurry, watermarks, oversaturated, distorted hands, amputation"
prompt_array = [
    "exploring the underwater city of Atlantis",
    "observing colorful fish through a crystal window",
    "swimming over coral reefs to a grand palace",
    "gliding through the currents near the palace",
    "darting through an open underwater plaza",
    "swims to a majestic temple near the kelp forest"
]
...
pdf_path = os.path.join(output_dir, "generated_images_superdog_underwater_2.pdf")
